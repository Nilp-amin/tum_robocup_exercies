...
private:
  float pre_pass_low_, seg_pass_low_;                    // pass filter lower limit
  float pre_pass_high_, seg_pass_high_;                    // pass filter upper limit
  float ransac_thresh_;               // RANSAC outlier threshold
